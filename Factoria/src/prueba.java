...
public class prueba {
	...
	public static void main(String[] args) {		
		...
		if(fabrica.iniciarFabricacion(15)==false) {
		...
		if(fabrica.retirarCoche(1)==false) {
		...
		if(fabrica.retirarCoche(2,2)==false) {
			System.out.println("No hay coches del color seleccionado suficientes");
		}
		else {
			System.out.println(fabrica);
		}
